<%@ Page Title="" Language="C#" MasterPageFile="~/Portal.Master" AutoEventWireup="true" CodeBehind="Project.aspx.cs" Inherits="SaifLogic.Project" %>
...
<%--                          <asp:TextBox ID="txtLongDesc" runat="server"class="mdc-text-field__input" TextMode="MultiLine"></asp:TextBox>--%>
                        ...
                        <br />
                        <center>
                        <asp:Button class="mdc-button mdc-button--raised" id="cmdSubmit" Text="Update Project Details" runat="server" OnClick="cmdSubmit_Click" />
